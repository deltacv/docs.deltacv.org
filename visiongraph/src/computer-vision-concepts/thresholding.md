...
#### Thresholding in VisionGraph

In VisionGraph, you use the Color Threshold node (found in the Image Processing category) to apply this technique. This node gives you powerful control:
