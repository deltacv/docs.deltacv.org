...
In VisionGraph, the "Bounding Rectangles" Node handles this task, taking a complex contour and outputting a simple, upright box.
...
In VisionGraph, you'll use the "Bounding Rotated Rectangles" node to generate this more detailed and precise data from a list of contours
