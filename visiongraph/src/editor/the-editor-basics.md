...
When creating a new project for the first time, it is recommended to go through the "Guided Tour" to learn the basics of using the VisionGraph editor. Click on the "Guided Tour" button when the welcome dialog comes up;
