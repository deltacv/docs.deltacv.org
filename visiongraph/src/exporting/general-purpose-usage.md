...
The core steps to use your VisionGraph-generated pipeline outside of FTC involve setting up a **VisionLoop** configuration:
...
This code snippet shows how to quickly create a VisionLoop, attach your generated `MyVisionGraphPipeline` class, and display the result in a window on your computer:
...
public class DesktopVisionApp {
    public static void main(String[] args) {
        // Assume 'MyVisionGraphPipeline' is the class generated by VisionGraph
        MyVisionGraphPipeline pipeline = new MyVisionGraphPipeline(); 
