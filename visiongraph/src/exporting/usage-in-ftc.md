...
The primary goal of building a visual pipeline in VisionGraph is to generate reliable Java code that can be integrated directly into your FTC robot's OpMode. This process involves three main steps: Generation, Integration, and Data Access.
...
1. **Generate the File:** The editor creates a `.java` file (e.g., `MyVisionGraphPipeline.java`) that contains all the complex computer vision logic you designed visually.
...
import org.firstinspires.ftc.teamcode.vision.MyVisionGraphPipeline; 
// ... other imports

public class MyVisionOpMode extends LinearOpMode {
    OpenCvWebcam webcam;
    MyVisionGraphPipeline pipeline;

    @Override
    public void runOpMode() {
        // 1. Instantiate your pipeline
        pipeline = new MyVisionGraphPipeline(); 
