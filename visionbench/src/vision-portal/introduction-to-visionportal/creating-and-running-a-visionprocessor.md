...
## Adding processors to VisionBench
...
Once you have added a processor using any of the methods mentioned before, executing it is very simple. Your processor should appear in the "Pipelines" list once it's part of a workspace or added to VisionBench's source code:
...
![GrayProcessor running live in VisionBench](<../../assets/image (3) (1).png>)
