...
`OpenCvPipeline`s are the main executable unit in VisionBench, and they can be created [as explained here](./). The lifecycle is automatically managed by the sim, which calls:
...
## Adding pipelines to VisionBench
