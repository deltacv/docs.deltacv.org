...
It's sometimes useful to log data from your vision code to know the result in real time. To do this, we partially implement the basic Telemetry interface that is present in the FTC SDK (e.g methods like `Telemetry#talk`are not implemented) to follow the main idea of VisionBench of "easily copy-pasting into an FTC SDK project".
