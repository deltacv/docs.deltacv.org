...
Both IntelliJ IDEA and VS Code are the IDE and Text Editor recommended to use for VisionBench. While IntelliJ is a fully featured IDE specifically designed for Java, with consistent and great autocompletion, refactoring features, etc, VS Code is more lightweight and faster in computers with limited resources.

This guide will explain how to use any of these two, you can choose whichever suits you the best.

## VS Code

**Make sure you installed a JDK as explained in the** [**Downloading VisionBench**](../downloading-visionbench.md) **section.**
...
3. Once you have done the steps in that section, go back to VS Code. If it wasn't opened automatically by VisionBench, open it manually and select the folder you created in VisionBench.
...
If you have VisionBench opened, every time you save the file in the editor (you can use Ctrl + S) a new build will be executed. If your pipeline was compiled successfully, it will be added to the list with a "gears" icon in the list to differentiate it.
...
If you have VisionBench opened, every time you make a change in IntellIj a new build will be executed. If your pipeline was compiled successfully, it will be added to the list with a "gears" icon in the list to differentiate it.

## Creating a Gradle workspace

1. Open VisionBench (follow [this page](../downloading-visionbench.md#running-visionbench) if needed)
